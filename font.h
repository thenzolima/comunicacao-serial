// Fontes para caracteres 8x8 – inclui dígitos, letras maiúsculas e minúsculas
// Os 10 primeiros conjuntos (8 bytes cada) podem ser, por exemplo, para "nada" e dígitos
static uint8_t font[] = {
    // 0: Espaço (ou nada)
    ...
    // Letras minúsculas a-z (exemplos; sinta-se livre para criar seus próprios desenhos)
